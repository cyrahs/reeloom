...
M8 起，PostgreSQL 17 是所有 control-plane metadata 的唯一事实来源。媒体、write-only
Secret、content-addressed Plan 和 Executor Journal 仍由文件系统各自唯一拥有。
不提供 backend toggle、filesystem fallback 或 dual-write。
