...
class RuntimeErrorCode(StrEnum):
    ...
    VIDEO_SUBTITLE_PROBE_FAILED = "video_subtitle_probe_failed"
    SEASON_ALREADY_PROBED = "season_already_probed"
    EXTERNAL_SUBTITLES_PRESENT = "external_subtitles_present"
    SUBTITLE_SEARCH_NOT_ALLOWED = "subtitle_search_not_allowed"
    SUBTITLE_SEARCH_FAILED = "subtitle_search_failed"
    SUBTITLE_SEARCH_CURSOR_INVALID = "subtitle_search_cursor_invalid"
    UNKNOWN_SUBTITLE_ARCHIVE_SET = "unknown_subtitle_archive_set"
    SUBTITLE_SELECTION_INVALID = "subtitle_selection_invalid"
    SUBTITLE_WORKFLOW_INCOMPLETE = "subtitle_workflow_incomplete"
